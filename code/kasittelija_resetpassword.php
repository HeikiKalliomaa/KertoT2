...
$virheet_palvelin['invalidLink'] = "Password activation link is not valid.";
$virheet_palvelin['invalidToken'] = "The Link is Invalid.";
...
if (empty($virheet) && empty($virheet['password2']) and empty($virheet['password'])) {
    if ($_POST['password'] != $_POST['password2']) {
        $virheilmoitukset['password2'] = "Passwords do not match.";
